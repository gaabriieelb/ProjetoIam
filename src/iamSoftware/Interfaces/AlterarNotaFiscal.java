...
public class AlterarNotaFiscal extends javax.swing.JFrame {
     ...
     */
    public AlterarNotaFiscal(int id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Alteração de Nota Fiscal");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       PesquisaFornecedor pesquisafornecedor = new PesquisaFornecedor("alterarnotafiscal");
       pesquisafornecedor.setVisible(true);
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        PesquisaProduto pesquisaproduto = new PesquisaProduto("alterarnotafiscal");
    ...
    public void preencherCampos(int id) throws SQLException{
        String item = String.valueOf(id);
        String sql = "SELECT * FROM `notas` WHERE id ="+item;
            ...
            while(rs.next()){
                String numNota = rs.getString("numeronota");
                ...
                fieldNomeFornecedor.setText(nomeFornecedor);
