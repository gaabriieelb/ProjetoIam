...
public class PesquisaEmpresaConveniada extends javax.swing.JFrame {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if(radioIgual.isSelected()){
           sql = "SELECT * FROM empresasconveniadas WHERE nome LIKE '"+nome+"'";
        }
        ...
        try {
            ...
            Logger.getLogger(PesquisaEmpresaConveniada.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaEmpresaConveniada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaEmpresaConveniada().setVisible(true);
            }
        });
