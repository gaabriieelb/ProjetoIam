...
public class CadastroCartao extends javax.swing.JFrame {
    ...
    public CadastroCartao() {
        ...
        try {
            ...
            Logger.getLogger(CadastroCartao.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        fieldComissao = new javax.swing.JTextField();
        ...
        tblProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Bandeira", "Prazo (dias)", "Taxa Comissão (%)"
            }
        ) {
        ...
        jLabel8.setText("Consulta e Alteração de Cartão");
        ...
        jLabel9.setText("Cadastro de Cartão");
        ...
        fieldComissao.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            try{
                ...
                PreencherTabela();
                String msg = "Cartão excluido com Sucesso!";
                Mensagem mensagem = new Mensagem(msg);
                mensagem.setVisible(true);
            }
            catch (SQLException ex) {
                Logger.getLogger(CadastroCartao.class.getName()).log(Level.SEVERE, null, ex);
                Mensagem mensagem = new Mensagem("Não foi possível excluir o Cartão!");
                mensagem.setVisible(true);
            }
        }
        catch (Exception e)
        {
            Mensagem mensagem = new Mensagem("Selecione um cartão!");
            mensagem.setVisible(true);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            int id = (int) tabela.getValueAt(row, 0);
            String bandeira = (String) tabela.getValueAt(row, 1);
            String prazo = (String) tabela.getValueAt(row, 2);              
            double tc =  (double) tabela.getValueAt(row, 3);
            String taxacomissao = ""+tc;
            
            CartaoAlterar cartaoAlterar = new CartaoAlterar(bandeira, prazo, taxacomissao, id);
            System.out.println("foi aqui");
            cartaoAlterar.setVisible(true);
        } 
        catch (Exception e)
        {
            Mensagem mensagem = new Mensagem("Selecione um Cartão!");
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        ...
        else
        {
            ...
            cartao.setTaxaComissao(comissao);        
            
            try {
                cartao.Cadastrar();
                PreencherTabela();

                fieldBandeira.setText("");
                fieldPrazo.setText("");            
                fieldComissao.setText("");
                
                
                Mensagem mensagem = new Mensagem("Cartão cadastrado com sucesso!");
                mensagem.setVisible(true);
    ...
    private javax.swing.JTextField fieldComissao;
